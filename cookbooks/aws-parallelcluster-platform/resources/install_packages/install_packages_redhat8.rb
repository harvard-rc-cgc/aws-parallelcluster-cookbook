...
def default_packages
  ...
  packages = %w(vim-minimal vim-filesystem vim-common vim-enhanced ksh tcsh zsh openssl-devel ncurses-devel pam-devel net-tools openmotif-devel
     ...
     iproute NetworkManager-config-routing-rules python3 python3-pip iptables-nft iptables-libs libcurl-devel yum-plugin-versionlock
